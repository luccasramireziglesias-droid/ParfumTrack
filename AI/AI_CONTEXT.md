...
| **Tests** | 610 Vitest (unit/estáticos) + 94 Playwright (E2E). Los dos corren en CI. |
...
npm test                   # 610 tests Vitest
npx playwright test        # 94 tests E2E (necesita la app servida en :8787)
