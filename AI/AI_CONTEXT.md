...
| **Tests** | 621 Vitest (unit/estáticos) + 106 Playwright (E2E). Los dos corren en CI. |
...
npm test                   # 621 tests Vitest
npx playwright test        # 106 tests E2E (necesita la app servida en :8787)
